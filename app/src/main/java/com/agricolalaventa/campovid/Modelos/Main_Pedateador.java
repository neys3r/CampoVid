...
import com.agricolalaventa.campovid.Modelos.Main_MenuCampo;
import com.agricolalaventa.campovid.MySingleton;
...
public class Main_Pedateador extends AppCompatActivity {
            ...
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                if((keyEvent.getAction()==KeyEvent.ACTION_DOWN ) && (i==KeyEvent.KEYCODE_ENTER)  ){
                    ...
                    if(codPDA.isEmpty()){
                        ...
                        if ( longitud != 8) {
                            Toast.makeText(getApplicationContext(),"El DNI debe tener 8 dígitos, ",Toast.LENGTH_LONG).show();
                            edtVigilante.setText("");
                            edtVigilante.clearFocus();
                            edtVigilante.requestFocus();
                        }else if(db.miIdSucursal().length()!=3){

                            Toast.makeText(getApplicationContext(),"PDA no Activo, Sincronizar!!!!",Toast.LENGTH_LONG).show();
                            edtVigilante.setText("");
                            edtVigilante.clearFocus();
                            edtVigilante.requestFocus();
                            ...
                            //ii.putExtra("codPDA", codPDA);
                            //startActivity(ii);
                        }else if(db.areaVigilante(idvigilante).equalsIgnoreCase("campo")){

                            Toast.makeText(getApplicationContext(),"Ingresando a Modo Campo",Toast.LENGTH_LONG).show();
                            //Toast.makeText(getApplicationContext(),mensaje,Toast.LENGTH_LONG).show();
                            Intent ii =new Intent(getApplicationContext(), Main_MenuCampo.class);
                            //ii.putExtra("codPDA", codPDA);
                            startActivity(ii);
                        }
                        else {
